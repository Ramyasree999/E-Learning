      ...
      if(uname==null)
{
   ...
   Class.forName("com.mysql.jdbc.Driver");
    ...
    PreparedStatement ps1 = conn.prepareStatement("select * from btestval where uname= '"+uname+"'");
        ResultSet rs1= ps1.executeQuery();
        if(!rs1.next()){
        PreparedStatement ps2 = conn.prepareStatement("insert into btestval(uname) values ('"+uname+"')");
        ps2.executeUpdate();
        }
    if(dig>=2&&dig<=6&&score<=35)
    {
...
<script type="text/javascript">
    ...
    window.location.replace("basiclinks.jsp");
             ...
             <div class="col-md-offset-4 form-inline" style="margin-top: 8%;font-size: 200%">    Your score in the previous test is Low. You cannot view this content <br><br>
            <a href="basiclinks.jsp" style="margin-left :130px;">Learn</a> <br><br>
            <a href="userhome.jsp" style="margin-left :130px;">Back to Home</a> </div>
<%     
             }
...
%>
  ...
  <!-- <iframe height="500" width="1300" src=<% out.println(url); %></iframe> -->
<br>
    <br>
    <iframe  style="margin-left :320px;margin-top: 2%" align="center" width="900" height="500" src="<% out.println(url); %>" frameborder="0" allowfullscreen></iframe><br><br>
