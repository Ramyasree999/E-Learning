...
<html>
    ...
    <body>
        ...
        <div class="container" style="margin-top:-50px;width:100%">
            ...
            </div> <h1 align="center"> Test Result </h1><br>
            <div class="col-md-offset-2 form-inline" style="margin-top: 2%;font-size: 100%">
              
                
<% String d = (String)session.getAttribute("dd");%> 
<% int dig = Integer.parseInt(d); %> 
<% String a =(String)session.getAttribute("att");
int att = Integer.parseInt(a);
String t = (String)session.getAttribute("temp");
int temp = Integer.parseInt(t);
String bi = (String)session.getAttribute("bef");
int bef = Integer.parseInt(bi);

%>
<% Class.forName("com.mysql.jdbc.Driver");
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3308/elearning", "root", "root");
   PreparedStatement pis = conn.prepareStatement("select * from responseofc where uname='"+uname+"'and tno='"+dig+"' and attno='"+att+"'");
   ResultSet r = pis.executeQuery();
   int[] ar = new int[5];
   int[] b = new int[5];
   if(r.next())
{
...
{ 
    ...
    <table style="margin-left:30%">
            <tr><td>1) Which of the following are Tokens?
</td></tr>
            <tr><td>
            ...
            <tr><td><br></td></tr>
            <tr><td> Your Ans: <% out.println(ar[0]);%></td></tr>
            <% if(ar[0]==b[0]){
                %> <tr><td> <img height="30" width="30" src="images/tick.jpg"></td></tr>
                <%
            }
            else
            {%><tr><td><img height="30" width="30" src="images/wrong1.jpg"></td></tr>
                <%
            }
            %> <tr><td><br></td></tr>
            ...
            <tr><td><br></td></tr>
            <tr><td> Your Ans: <% out.println(ar[1]);%></td></tr>
            <% if(ar[1]==b[1]){
                %> <tr><td> <img height="30" width="30" src="images/tick.jpg"></td></tr>
                <%
            }
            ...
            <tr><td><br></td></tr>
            <tr><td> Your Ans: <% out.println(ar[2]);%></td></tr>
            <% if(ar[2]==b[2]){
                %> <tr><td> <img height="30" width="30" src="images/tick.jpg"></td></tr>
                <%
            }
            ...
            <tr><td><br></td></tr>
            <tr><td> Your Ans: <% out.println(ar[3]);%></td></tr>
            <% if(ar[3]==b[3]){
                %> <tr><td> <img height="30" width="30" src="images/tick.jpg"></td></tr>
                <%
            }
...
<form action="basictestvalid.jsp" method="post" style="max-width:500px;margin:auto">
    ...
    What is the output of this C code?
            ...
            <tr><td><br></td></tr>
            <tr><td> Your Ans: <% out.println(ar[4]);%></td></tr>
            <% if(ar[4]==b[4]){
                %> <tr><td> <img height="30" width="30" src="images/tick.jpg"></td></tr>
                <%
            }
...
%>
 ...
 <div class="col-md-offset-5 form-inline" style="font-size: 150%">
                    
                    <% String c = (String)session.getAttribute("co"); %>
<% int co =Integer.parseInt(c);
if(bef!=-1)
out.println("<br><br>Your previous score is "+bef);
out.println("<br><br>Your current score is "+temp);
out.println("<br><br>Your final score is "+co);


%>
<% if(co==5){
    %><img height="60" width="60" src="images/donewell.jpg"><%
    out.println("<br>Continue to learn...."+"<a href='basiclinks.jsp'>Learn</a>");}
 else if(co==4){
     %><img height="60" width="60" src="images/good.png"><%
    out.println("Keep it up!!! <br>"+"Continue to learn...."+"<a href='basiclinks.jsp'>Learn</a>");
 }
 else if(co==3){
     %><img height="60" width="60" src="images/good.png"><%
    out.println("Improve more!!! <br>"+"Continue to learn...."+"<a href='basiclinks.jsp'>Learn</a>");
 }
 else{
     %><img height="60" width="60" src="images/oops.jpg"><%
    out.println("You have to try harder!!! <br>"+"Continue to learn...."+"<a href='basiclinks.jsp'>Learn</a>");
 } 
    %>
