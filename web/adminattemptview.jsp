...
if(uname==null)
{
    ...
    <body>
        ...
        <% String ui = (String)session.getAttribute("un");
...
PreparedStatement ps = conn.prepareStatement("select * from testscore where uname='"+ui+"' and tno='"+idd+"'");
        ResultSet rs = ps.executeQuery();
        PreparedStatement ps1 = conn.prepareStatement("select * from testnames where id='"+idd+"'");
        ResultSet rs1 = ps1.executeQuery();
        rs1.next();%> <h4 style="margin-top: -5%;color: white"> <% out.println(ui); %> </h4>
