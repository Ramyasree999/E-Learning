      ...
      if(uname==null)
{
   ...
   Class.forName("com.mysql.jdbc.Driver");
    ...
    id=rs2.getInt(5);
        ...
        ps5.executeUpdate();;}
    PreparedStatement ps1 = conn.prepareStatement("select * from itestval where uname= '"+uname+"'");
        ResultSet rs1= ps1.executeQuery();
        if(!rs1.next()){
        PreparedStatement ps2 = conn.prepareStatement("insert into itestval(uname) values ('"+uname+"')");
        ps2.executeUpdate();
        }
        if(score<35){
            //out.println(score);
            PreparedStatement ps5 = conn.prepareStatement("select * from btestval where uname='"+uname+"'");
    ...
    window.location.replace("basiclinks.jsp");
            ...
            <a href="userhome.jsp" style="margin-left :130px;">Back to Home</a> </div>
                ...
                %>
              <!--  <script type="text/javascript">
    alert("U dint take prev test in basic");
    window.location.replace("basiclinks.jsp");</script> -->
             <div class="col-md-offset-4 form-inline" style="margin-top: 10%;font-size: 200%"> You have not taken the previous test in basic <br><br>
            <a href="basiclinks.jsp" style="margin-left :130px;">Learn</a> <br><br>
            <a href="userhome.jsp" style="margin-left :130px;">Back to Home</a> </div>
                <%
            }
        }
    if(dig>=8&&dig<=12&&score<=75){
        
        PreparedStatement ps = conn.prepareStatement("select * from itestval where uname ='"+uname+"' ");
...
<script type="text/javascript">
    ...
    window.location.replace("basiclinks.jsp");
</script> --> <div class="col-md-offset-4 form-inline" style="margin-top: 10%;font-size: 200%"> You have not taken the previous test in this level <br><br>
            <a href="basiclinks.jsp" style="margin-left :130px;">Learn</a> <br><br>
            <a href="userhome.jsp" style="margin-left :130px;">Back to Home</a> </div>
<%     
        }
...
<script type="text/javascript">
    alert("U score in prev test is low please read again take test");
    window.location.replace("basiclinks.jsp");
</script> --> <div class="col-md-offset-4 form-inline" style="margin-top: 10%;font-size: 200%"> Your score in the previous test is Low. You cannot view this content <br><br>
            <a href="basiclinks.jsp" style="margin-left :130px;">Learn</a> <br><br>
            <a href="userhome.jsp" style="margin-left :130px;">Back to Home</a> </div>
<%     
             }
